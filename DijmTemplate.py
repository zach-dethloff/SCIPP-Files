...
mjj_val = val[b'mjj'][big_mask]

back_val = b1[b'mjj'][back_mask]

back2_val = b2[b'mjj'][back2_mask]

backsum = np.append(back_val, back2_val)

backweights = np.append(b1[b'weight'][back_mask], b2[b'weight'][back2_mask])

plt.hist(mjj_val, bins=100, range=(2000,14000),
	color='g', label='Signal Dijet Mass', alpha = 0.5,
	weights=val[b'weight'][big_mask])
plt.hist(back_val, bins=100, range=(2000,14000),
	color = 'r', label='Background Dijet Mass', alpha=0.5,
	weights=b1[b'weight'][back_mask])
plt.hist(back2_val, bins=100, range=(2000,14000),
	color = 'b', label = 'Background Dijet Mass 2',alpha=0.5,
	weights=b2[b'weight'][back2_mask])
plt.hist(backsum, bins = 100, range=(2000,14000), 
	color='orange', label = 'Background Dijet Mass sum', alpha = 0.5,
	weights = backweights)
